...
**Mobile users:** the Android app is available as a prebuilt APK — grab `xh_mobile.apk` directly from the [Releases page](https://github.com/XATUM/XenHide/releases) and sideload it (no build steps required).
